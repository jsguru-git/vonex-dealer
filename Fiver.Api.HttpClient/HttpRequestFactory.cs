...
namespace Fiver.Api.HttpClient
{
    public static class HttpRequestFactory
    {
        ...
        public static async Task<HttpResponseMessage> Get(string requestUri, string authType, string authValue)
        {
            var builder = new HttpRequestBuilder()
                                .AddMethod(HttpMethod.Get)
                                .AddRequestUri(requestUri)
                                .AddAuthHeader(authType, authValue);

            return await builder.SendAsync();
        }
        public static async Task<HttpResponseMessage> Get(string requestUri, KeyValuePair<string,string> cookie)
        {
            var builder = new HttpRequestBuilder()
                                .AddMethod(HttpMethod.Get)
                                .AddRequestUri(requestUri)
