...
namespace VonexDealer.API.Migrations
{
    ...
    [Migration("20180322014905_address")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VonexDealer.API.Models.Order.Customer", b =>
                {
                    ...
                    b.Property<long?>("AddressDetailsAddressID");
            ...
            modelBuilder.Entity("VonexDealer.API.Models.Order.HardwareOrder", b =>
                {
                    b.Property<long>("HardwareOrderID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasKey("HardwareOrderID");

                    b.ToTable("HardwareOrder");
                });

            modelBuilder.Entity("VonexDealer.API.Models.Order.HardwareOrderDetail", b =>
                {
                    b.Property<long>("HardwareOrderDetailID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasKey("HardwareOrderDetailID");

                    b.HasIndex("HandsetID");

                    b.HasIndex("HardwareOrderID");

                    b.ToTable("HardwareOrderDetail");
                });
            ...
            modelBuilder.Entity("VonexDealer.API.Models.Order.IPExtension", b =>
                {
                    ...
                    b.Property<long?>("HandsetSelectedHandsetID");
                    ...
                    b.Property<int?>("RatePlanMixnMatchID");

                    b.Property<string>("VoicemailEmail");

                    b.HasKey("IPExtensionID");

                    b.HasIndex("HandsetSelectedHandsetID");

                    b.HasIndex("IPOrderID");

                    b.HasIndex("RatePlanMixnMatchID");
            ...
            modelBuilder.Entity("VonexDealer.API.Models.Order.IPOrder", b =>
                {
                    ...
                    b.Property<int?>("RatePlanDetailsID");
            ...
            modelBuilder.Entity("VonexDealer.API.Models.Order.Order", b =>
                {
                    ...
                    b.Property<long?>("LandlineDetailsLandlineID");
                    ...
                    b.HasIndex("LandlineDetailsLandlineID");
            ...
            modelBuilder.Entity("VonexDealer.API.Models.Order.HardwareOrderDetail", b =>
                {
                    b.HasOne("VonexDealer.API.Models.Order.Handset", "handset")
                        .WithMany()
                        .HasForeignKey("HandsetID");

                    b.HasOne("VonexDealer.API.Models.Order.HardwareOrder")
                        .WithMany("HardwareOrderDetails")
                        .HasForeignKey("HardwareOrderID")
                        .OnDelete(DeleteBehavior.Cascade);
                });

            modelBuilder.Entity("VonexDealer.API.Models.Order.IPExtension", b =>
                {
                    b.HasOne("VonexDealer.API.Models.Order.Handset", "HandsetSelected")
                        .WithMany()
                        .HasForeignKey("HandsetSelectedHandsetID");

                    b.HasOne("VonexDealer.API.Models.Order.IPOrder")
                        .WithMany("Extensions")
                        .HasForeignKey("IPOrderID");

                    b.HasOne("VonexDealer.API.Models.UB.RatePlan", "RatePlanMixnMatch")
                        .WithMany()
                        .HasForeignKey("RatePlanMixnMatchID");
                });

            modelBuilder.Entity("VonexDealer.API.Models.Order.IPOrder", b =>
                {
                    b.HasOne("VonexDealer.API.Models.Order.HardwareOrder", "HardwareOrderDetails")
                        .WithMany()
                        .HasForeignKey("HardwareOrderID");

                    b.HasOne("VonexDealer.API.Models.UB.RatePlan", "RatePlanDetails")
                        .WithMany()
                        .HasForeignKey("RatePlanDetailsID");
                });
            ...
            modelBuilder.Entity("VonexDealer.API.Models.Order.Order", b =>
                {
                    ...
                    b.HasOne("VonexDealer.API.Models.Order.DirectDebit", "DirectDebitDetails")
                        .WithMany()
                        .HasForeignKey("DirectDebitID");

                    b.HasOne("VonexDealer.API.Models.Order.Hardware", "HardwareDetails")
                        .WithMany()
                        .HasForeignKey("HardwareID");

                    b.HasOne("VonexDealer.API.Models.Order.IPOrder", "IPOrderDetails")
                        .WithMany()
                        .HasForeignKey("IPOrderID");

                    b.HasOne("VonexDealer.API.Models.Order.Internet", "InternetDetails")
                        .WithMany()
                        .HasForeignKey("InternetID");

                    b.HasOne("VonexDealer.API.Models.Order.Landline", "LandlineDetails")
                        .WithMany()
                        .HasForeignKey("LandlineDetailsLandlineID");
                });
